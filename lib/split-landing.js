...
function sceneStream() {
  ...
  return `<section class="cw-scene">
    <div class="cw-scene-inner">
      ...
      <h2 class="cw-section-title">Eleven modules. <em>One</em> intelligence layer.</h2>
      <p class="cw-sub" style="margin-bottom:28px;max-width:52ch">Eleven production modules share one intelligence graph. Connected market narratives come first, then the data behind them — portfolio, movers, insiders, and market stories on the same layer.</p>
...
function scenePlans() {
  return `<section class="cw-scene cw-scene--center">
    <div class="cw-scene-inner">
      ...
      <p class="cw-sub" style="text-align:center;margin:0 auto 16px;max-width:52ch;opacity:0.72;font-size:13px">11 modules · one graph. Portfolios, earnings, macro, insiders, market stories, and Deep Dive on one intelligence graph.</p>
      <div class="cw-monoliths">
        <div class="cw-monolith">
          ...
          <ul>
            ...
            <li>Ask Logic preview (5 daily): market pulse, tickers, risk regime, daily brief</li>
            <li>Discover Stocks: market story preview</li>
            <li>What's Moving: daily briefing wheel</li>
            <li>Core macro context</li>
            <li>Ticker Deep Dive from key modules</li>
          </ul>
        ...
        <div class="cw-monolith cw-monolith--feat">
          ...
          <ul>
            ...
            <li>Unlimited Ask Logic — portfolio, scenario &amp; sector modes</li>
            <li>Full Insider &amp; Smart Money Flow</li>
            <li>Full Discover Stocks &amp; portfolio correlation cluster</li>
            <li>Dashboard capital-flow visualization</li>
          </ul>
