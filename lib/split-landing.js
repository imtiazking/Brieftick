...
function heroMobileCtas() {
  ...
  return `<div class="cw-hero-ctas cw-hero-ctas--mobile" data-split-landing-hero-cta>
    <button type="button" class="cw-cta-pri cw-hero-cta-btn" data-split-action="signup">Start Free</button>
    <button type="button" class="cw-cta-sec cw-hero-cta-btn" data-split-action="demo">Explore Dashboard</button>
  </div>`;
}
