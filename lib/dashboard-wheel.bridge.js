...
import { renderWheelPulseStrip } from "/preview/dashboard-rail-mocks.js";
...
import { refreshMarketRiskState } from "/lib/market-risk-runner.js";
...
export function mountDashboardWheel() {
  ...
  refreshMarketRiskState({ fetchQuotes: true, fetchMacro: true, refreshImpact: true }).catch(
    (e) => console.warn("[dashboard wheel] market risk", e.message)
  );
  startDashboardLiveRefresh();
  hydrateDashboardPulse();
  wheelStarted = true;
