 ...
 */
const LOGIC_HELIX_SYMBOLS = ["VIX", "SPY", "QQQ", "NVDA", "TSLA", "AAPL"];
...
/** Design Lab HELIX_RINGS — 6 symbols across 2 primary rings */
...
function helixIdleCopy(sym) {
  const copy = {
    ...
    QQQ: "Growth beta sensitive to rates; megacap tech leadership defines near-term tape tone.",
    NVDA: "Semiconductor leadership under pressure as growth trades reprice; AI capex narrative remains intact.",
    TSLA: "High-beta growth sensitivity dominates; move reflects macro risk appetite on today's tape.",
