...
/** @typedef {'rate_limited'|'symbol_unavailable'|'parse_error'|'upstream_error'|null} FailureReason */
...
export function unavailableInstrument(key, failureReason = null) {
  ...
  const msg = failureReason ? failureReasonLabel(failureReason) : "Live source unavailable";
  ...
  return {
    ...
    error: isYield ? "Delayed / unavailable" : msg,
