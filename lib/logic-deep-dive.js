...
/** @type {Record<string, { quote?: object, name?: string, prompt?: string, answer?: string, confidenceLabel?: string }>} */
let bySymbol = {};

/**
 * @param {{ symbol: string, quote?: object, name?: string, prompt?: string, answer?: string, confidenceLabel?: string }} payload
 */
