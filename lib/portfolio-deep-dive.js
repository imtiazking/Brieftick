/**
 * Portfolio → Ticker Deep Dive (Phase 2.0 + 2.3 context).
 * @module lib/portfolio-deep-dive
 */

import { openTickerDeepDive, initTickerDeepDiveBridge } from "./ticker-deep-dive.bridge.js";
import { buildPortfolioContext } from "../preview/ticker-deep-dive/deep-dive-context.js";
...
function openPortfolioDeepDive(sym) {
  ...
  const quote = portfolioQuote(key);
